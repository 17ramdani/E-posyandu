...
<main class="main-content position-relative border-radius-lg ">
    ...
    <div class="container-fluid">
        ...
        <div class="row ">
            <form action="{{ url ('/timbangan/store') }}" method="POST">
                @csrf
                ...
                <div class="col-md-10">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="tgl_timbang" id="tgl_timbang">
                        </div>
                        <div class="form-group">
                            <label for="">Status Gizi</label>
                            <input type="text" class="form-control" name="status_gizi" id="status_gizi">
                        </div>
                        <div class="form-group">
                            <label for="">Keterangan</label>
                            <input type="text" class="form-control" name="ket_timbang" id="ket_timbang">
                        </div>
                        <div class="form-group">
                            <label for="">Index Naik</label>
                            <input type="text" class="form-control" name="ind_naik" id="ind_naik">
                        </div>
                        <div class="form-group">
                            <label for="">Index Tinggi Lalu</label>
                            <input type="text" class="form-control" name="ind_t_lalu" id="ind_t_lalu">
                        </div>
                        <div class="form-group">
                            <label for="">Index Berat Lalu</label>
                            <input type="text" class="form-control" name="ind_b_lalu" id="ind_b_lalu">
                        </div>
