...
<main class="main-content position-relative border-radius-lg ">
    ...
    <div class="container">
        ...
        <div class="row">
            <form action="{{ url ('/agenda/update/' .$data->id)  }}" method="POST">
                @csrf
                ...
                <div class="col-lg-12 mb-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="start" id="start" value="{{$data->start }}">
                    </div>
                    <div class="form-group">
                        <label for="">Tanggal Selesai</label>
                        <input type="date" class="form-control" name="end" id="end" value="{{$data->end }}">
                    </div>
                    <div class="form-group">
                        <label for="">Jenis Kegiatan</label>
                        <select class="form-control" name="j_kegiatan" id="j_kegiatan" value="{{$data->end }}">
                ...
                <button type="submit" class="btn btn-primary"><i class="fa-solid fa-pencil"></i>  Edit Data</button>
                <div class="form-group">
