...
<main class="main-content position-relative border-radius-lg ">
    ...
    <div class="container-fluid">
        ...
        <div class="row ">
            <form action="{{ url ('/imunisasi/store') }}" method="POST">
                @csrf
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="j_imun" id="j_imun">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="tgl_imun" id="tgl_imun">
                    </div>
                    <div class="form-group">
                        <label for="">Booster</label>
                        <input type="text" class="form-control" name="booster" id="booster">
                    </div>
                    <div class="form-group">
                        <label for="">Keterangan Imunisasi</label>
                        <input type="text" class="form-control" name="ket_imun" id="ket_imun">
                    </div>
