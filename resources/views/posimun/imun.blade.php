    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8  ">
                ...
                <a href="{{ url ('/imunisasi/create') }}" class="btn btn-primary mt-3"><i class="fa-solid fa-plus"></i> Data</a>
            </div>
            ...
            <table class=" table text-center">
                ...
                @foreach($data as $dataImun)
                <tr>
                    <td>{{ $dataImun->id }}</td>
                    <td>{{ $dataImun->nama_anak }}</td>
                    <td>{{ $dataImun->j_imun }}</td>
                    <td>{{ $dataImun->tgl_imun }}</td>
                    <td>{{ $dataImun->booster }}</td>
                    <td>{{ $dataImun->ket_imun }}</td>
                    <td>
                        <a href="{{ url ('/imunisasi/show/' .$dataImun->id) }}" class="btn btn-warning"><i class="fa-solid fa-pencil"></i></a>
                        <a href="{{ url('/imunisasi/destroy/'.$dataImun->id) }}" " 
