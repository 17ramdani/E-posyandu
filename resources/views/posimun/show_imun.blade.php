...
<main class="main-content position-relative border-radius-lg ">
    ...
    <div class="container">
        ...
        <div class="row">
            <form action="{{ url ('/imunisasi/update/' .$data->id)  }}" method="POST">
                @csrf
                ...
                <div class="col-lg-12 mb-3">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="j_imun" id="j_imun" value="{{$data->j_imun }}"> 
                            <option value=" hepatitis B"> Hepatitis B</option>
                            <option value=" polio"> Polio</option>
                            <option value=" BCG"> BCG</option>
                            <option value="campak rubella"> Campak Rubela</option>
                            <option value="DPT-HB-HiB">DPT-HB-HiB</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="">Tanggal Imunisasi</label>
                        <input type="date" class="form-control" name="tgl_imun" id="tgl_imun" value="{{$data->tgl_imun }}">
                    </div>
                    <div class="form-group">
                        <label for="">Booster</label>
                        <input type="text" class="form-control" name="booster" id="booster" value="{{$data->booster }}">
                    </div>
                    <div class="form-group">
                        <label for="">Keterangan</label>
                        <input type="text" class="form-control" name="ket_imun" id="ket_imun" value="{{$data->ket_imun }}">
                    </div>
                <button type="submit" class="btn btn-primary">Edit Data</button>
                <div class="form-group">
                    <a href="{{ url ('/imunisasi') }}">Kembali Ke Halaman Utama</a>
                </div>
            </div>
        </div>
