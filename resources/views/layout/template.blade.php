...
<head>
  ...
  <link rel="icon" type="image/png" href="{{ asset('dashboard') }}/assets/img/lg.png">
  <title>
    E-Posyandu
  </title>
  <!--     Fonts and icons     -->
  ...
  <!-- CSS Files -->
  <link id="pagestyle" href="{{ asset('dashboard') }}/assets/css/argon-dashboard.css?v=2.0.2" rel="stylesheet" />
</head>
...
<body class="g-sidenav-show bg-gray-400">
  ...
  <script src="{{ asset('dashboard') }}/assets/js/argon-dashboard.min.js?v=2.0.2"></script>
</body>
