...
<main class="main-content position-relative border-radius-lg ">
    ...
    <div class="container-fluid">
        ...
        <div class="row ">
            <form action="{{ url ('/anak/store') }}" method="POST">
                @csrf
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="tempat_lhr" id="tempat_lhr">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="bb_lahir" id="bb_lahir">
                    </div>
                    <div class="form-group">
                        <label for="">Tinggi Badan Lahir</label>
                        <input type="text" class="form-control" name="tb_lahir" id="tb_lahir">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="BPJS_anak" id="BPJS_anak">
                    </div>
