    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8  ">
                ...
                <a href="{{ url ('/anak/create') }}" class="btn btn-primary mt-3"><i class="fa-solid fa-plus"></i> Data</a>
            </div>
            ...
            <table class=" table text-center">
                ...
                <tr>
                    ...
                    <td>{{ $dataAnak->tempat_lhr }}</td>
                    <td>{{ $dataAnak->jenis_kelamin }}</td>
                    <td>{{ $dataAnak->anak_ke }}</td>
                    <td>
                        <a href="{{ url ('/anak/lihat/' .$dataAnak->id) }}" class="btn btn-primary"><i class="fa-solid fa-eye"></i></a>
                        <a href="{{ url ('/anak/show/' .$dataAnak->id) }}" class="btn btn-warning"><i class="fa-solid fa-pencil"></i></a>
                        <a href="{{ url('/anak/destroy/'.$dataAnak->id) }}" " 
